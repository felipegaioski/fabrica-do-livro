...
import { faArrowRightFromBracket, faBook, faChevronLeft, faListCheck, faTableColumns, faUser } from "@fortawesome/free-solid-svg-icons";
            ...
            <aside>
                <div className="top-content">
                    <div className="logo mb-3 d-flex align-items-center gap-2">
                        ...
                        <h1 className="d-none">Fábrica do Livro</h1>
                    </div>
                    <div className="user mb-3">
                        {user.name}
                    </div>
                    <hr />
                    <Link to="/dashboard"><FontAwesomeIcon icon={faTableColumns} className="sidemenu-icon"/>Dashboard</Link>
                    <Link to="/users"><FontAwesomeIcon icon={faUser} className="sidemenu-icon"/>Usuários</Link>
                    <Link to="/constructions"><FontAwesomeIcon icon={faListCheck} className="sidemenu-icon"/>Obras</Link>
                    <Link to="#"><FontAwesomeIcon icon={faListCheck} className="sidemenu-icon"/>Tarefas</Link>
                    <Link to="/audits"><FontAwesomeIcon icon={faBook} className="sidemenu-icon"/>Auditoria</Link>
                </div>
                <div className="bottom-content">
                    <a className="btn-logout" href="#" onClick={onLogout}>
                        <FontAwesomeIcon icon={faArrowRightFromBracket} className="sidemenu-icon"/>Sair</a>
                </div>
            </aside>
